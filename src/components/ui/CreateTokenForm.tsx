    ...
    <form className="" onSubmit={handleSubmit(createToken)}>
      ...
      <div className="space-y-5">
        <div className="col-span-full">
          <label className="block text-sm/6 font-medium text-gray-900">Collection {showContractForm ? 'Form' : 'Address'}</label>
          <div className="mt-2">
            ...
            {showContractForm && <div className="w-full flex flex-col space-y-3">
              <div className="mt-2">
                <input
